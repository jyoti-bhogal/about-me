---
title: "{generatervis}: R package to synthesise, visualise clinical data, and create a Research Data Management workflow \- Part 2"
subtitle: 
description: 
...
## 🧠 Mental model: How am I approaching this?
...
![*Mental model flow chart for the developed solution.*](mental_model_flow_chart.jpg)


The assumptions for this mental model are:
...
create_empty_fastq("patient_456", output_dir = dir_path)  
```
