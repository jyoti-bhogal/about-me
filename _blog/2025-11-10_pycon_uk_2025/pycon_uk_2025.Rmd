...
categories: [Software Sustainability Institute, Open Source Software, Open Data, Open Science, Free Software, Software, Django, Django Girls, Research Software, Meta data, Contact Theater, Manchester, Bee, England, United Kingdom, In Person] 
output:
...
')
```
*Video: The code output on the micro:bit reads ‘PyCon UK 25’ followed by an image of a duck, recorded by me.*
...
I contributed to the **‘[ACTS Research Software Stories](https://everse.software/RSQKit/acts_research_software_story)’** component of the **{RSQ}Kit**, developed within the **EVERSE project**. The dev sprint was hosted by **Michael Sparks** and **Caterina Doglioni** from the **University of Manchester**.
...
![*Image: Picture clicked by me of the Manchester bee - highlighted in yellow at the edge of the window - that welcomed me into my room and was absolutely reluctant to go out of the window 😆!*](bee_hotel_window.jpg) 
