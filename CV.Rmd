...
* Participated in hand-on workshop on R for Bayesian Statistics and integrating LLMs in R Shiny applications using `ellmer` R package.
* Attended various talks and panel discussions on applications of Python and R programming language in enterprises.

#### **HiddenREF Festival 2025, Birmingham, England | 7-8 October 2025**
* Participated in three sessions on assessment of non-traditional outputs.
...
* Volunteer to help run the conference smoothly by assisting technical AV.
...
* Contributed to various sessions on Open Data practices, including sessions Digital Identifiers and National Data Library.

#### **PyCon UK 2025, Manchester, England | 19-22 September 2025**
* Attended various talks and workshops on Python programming language and its applications in data science, software education, team building, machine learning, LLMs, and software development.
* Attended a one-day hands-on 'Django Girls Worhshop' to learn Django web application development.
...
* Participated in various hands-on workshops and panel discussions on Open Software practices, including seesions on Introduction to Python, and neuroinformatics software `movement`.
* Participated in the OSW Hackday to explore the concept and open source Python library `skimage` to create skeletonised images from masked images of animal, and driving nodes from the skeletonised image to simplify the further analysis.

#### **APAN60, Hong Kong | 27 July - 1 August 2025**
* Singed Memorandum of Understanding (MoU) on behalf of RSE Asia Association with APAN to collaborate on Research Software Engineering and Open Science initiatives in the Asia-Pacific region.
