...
**Email ID:** [bhogaljyoti1@gmail.com](mailto:bhogaljyoti1@gmail.com)  
**LinkedIn:** [jyoti-bhogal](https://www.linkedin.com/in/jyoti-bhogal)  
**Github:** [jyoti-bhogal](https://github.com/jyoti-bhogal)  
**Time Zone:** IST (UTC+5:30 hours)  

# **RELEVANT WORK EXPERIENCE**
#### **Incubation Fellow (RSE Asia), OLS (formerly Open Life Science),** January 2026 \- Present

* Migrate RSE Asia website to new web framework and theme
* Ongoing maintenance of the RSE Asia website
* Curate a Jobs Board
* Organise and manage RSE Asia meetups
* Create event outcome materials like video recordings, resource sheets, and summary blog posts
* RSE Asia Survey 
* **Software Tools:** Hugo, HugoBlox (with Research Group theme), VS Code, git, GitHub, HTML, CSS
...
* Promoting the project and reporting the progress at the biannual [Asia Pacific Advanced Network (APAN)](https://apan.net/) meetings
...
#### **Research Software Engineering Contributor, Walter and Eliza Hall Institute of Medical Research (WEHI),** November 2024 \- Present (Remote, Volunteer)
...
#### **Research Software Community Manager, Research Software Alliance (ReSA),** September 2024 - September 2025 (part-time)
...
* **Software Tools:** Hugo framework, VS Code (Terminal), GitHub, git, HTML, CSS
...
* *Sanofi Research & Development Data Office (June 2023 \- September 2024\)*  
  ...
  * Deeply involved in regular stakeholder communications (business and technical), decision-making, and strategising.  
...
* Simulated optimal Clinical Trial design to optimise trial cost or statistical power of testing the effectiveness of a drug formula.  
...
#### **Research Software Engineering (RSE) Asia Association, Volunteer  Co-Lead,** September 2021 \- Present

* <span style="color: #63458A ; font-weight: bold;">What is RSE Asia Association?</span>
  <details>
  <summary style="color: #63458A ; font-weight: bold;">Click here to see more description</summary>
...
* She co-Chaired the 3rd and 4th annual successfully running Research Software Engineering Asia Australia Unconference 2024 (RSEAA24) and the  RSAA25 conference.
...
* <span style="color: #63458A ; font-weight: bold;">International Council of RSE Associations</span>
  <details>
  <summary style="color: #63458A ; font-weight: bold;">Click here to see more description</summary>
...
#### **OLS (formerly Open Life Science) Graduate,** Open Science Project

* <span style="color: #63458A ; font-weight: bold;">What is OLS (formerly Open Life Science)?</span>
  <details>
  <summary style="color: #63458A ; font-weight: bold;">Click here to see more description</summary>
...
### _**Conferences that I participated in:**_

#### **HiddenREF Festival 2025, Birmingham, England | 7-8 October 2025**
* Participated in three sessions on the assessment of non-traditional outputs.
* Presented a lightning talk on 'Community as Infrastructure: Uncovering the Hidden Impact of Research Software in Research Excellence'.
* Volunteer to help run the conference smoothly by assisting with technical AV.

#### **Open Data Camp 10 (ODC10), Edinburgh, Scotland | 27-28 September 2025**
* Organised a hands-on session on 'Drawing Parallels: A Unicorn Mandala Art Workshop on Open Data & Collaborations'.
* Contributed to various sessions on Open Data practices, including sessions on Digital Identifiers and National Data Library.

#### **PyCon UK 2025, Manchester, England | 19-22 September 2025**
* Attended various talks and workshops on the Python programming language and its applications in data science, software education, team building, machine learning, LLMs, and software development.
* Attended a one-day hands-on 'Django Girls Workshop' to learn Django web application development.
* Presented a lightning talk on 'Five Common Research Data Management Issues & How to Resolve them: With Python Packaging using ‘Hatch’ from PyPI'.

#### **R Dev Day @ RSECon25, Coventry, England | 8 and 12 September 2025**
* Participated in the dev day to contribute to enhancing documentation of `var.test()` function.
* Contributed to the R `glossary` package to test pre-commit with 'Write' access to repository.

#### **RSECon25, Coventry, England | 9-11 September 2025**
* Presented a lightning talk and poster on 'Enabling Research Software Excellence through RSE Community Conversations: An African and Asian Collaboration'.
* Presented updates from the RSE Asia Association at the RSE Worldwide session.
* Volunteered to help run the conference smoothly.

#### **Open Software Week, London, England | 11-15 August 2025**
* Participated in various hands-on workshops and panel discussions on Open Software practices, including sessions on Introduction to Python, and neuroinformatics software `movement`.
* Participated in the OSW Hackday to explore the concept and open source Python library `skimage` to create skeletonised images from masked images of animals, and derive nodes from the skeletonised image to simplify further analysis.

#### **APAN60, Hong Kong | 27 July - 1 August 2025**
* Signed Memorandum of Understanding (MoU) on behalf of RSE Asia Association with APAN to collaborate on Research Software Engineering and Open Science initiatives in the Asia-Pacific region.
* Presented a talk on 'Understanding the Personas of Research Software Engineers from Asian Institutes'.
* Held a Warli Art-themed RSE Asia meetup to foster community networking. 

#### **Invited Talk, Edinburgh, Scotland | 16 May 2025**

* Presented a talk on my ‘Research Study on the Research Software Engineering (RSEng) Landscape’ at the EPCC, University of Edinburgh.
* [Blog post](https://jyoti-bhogal.github.io/about-me/blog/2025-05-27_epcc_talk/) about the talk.
...
* Jyoti presented a remote talk at the OSDWG session on the topic ‘Building Bridges: Advancing Research Software Engineering and Open Science in Asia’, and also chaired the session.

#### **PyCon India 2024, Bengaluru, India | 12-15 September 2024**
...
### _**Conferences that I attended:**_

#### **EARL Tech Conference 2025 (Enterprise Applications of the R Language 2025), Brighton, England | 14-16 October 2025**
* Participated in a hands-on workshop on R for Bayesian Statistics and integrating LLMs in R Shiny applications using the `ellmer` R package.
* Attended various talks and panel discussions on applications of Python and the R programming language in enterprises.

#### **Collaborations Workshop 2025, Stirling, Scotland | 13-15 May 2025**

* Contributed to Green Algorithm’s ‘[MetaGreenData](https://github.com/GreenAlgorithms/MetaGreenData)’ project on hack day and won 1st place amongst 10 teams.
* Wrote a speed blog on the theme ‘futureproofing research software’.
* Contributed to a mini-workshop on ‘How do you ensure your science is seen, used and sustained?’
* Attended keynotes, lightning talks, panel discussions, and social sessions.
...
1. Yo Yehudi, Executive Director, OLS
2. Malvika Sharan, Director of Strategy and Partnership, OLS  
3. Rowland Mosbergen,  RCP Strategic Engagement and Planning Manager,  Walter and Eliza Hall Institute of Medical Research
4. Anelda van der Walt, Director & Trainer, Talarify

# **EDUCATION**

**Savitribai Phule Pune University (SPPU),** Pune, India - *M.Sc.(Statistics) |* July 2018 \- June 2020| CGPA: 9.25/10 | University Rank: 3

**Savitribai Phule Pune University (SPPU),** Pune, India - *B.Sc.(Statistics) |* July 2014 \- June 2018 | Percentage: 96.83% | University Rank: 3
