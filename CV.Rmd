...
* Participated in the dev day to contribute to enhancing documentation of `var.test()`.
* Contributed to R `glossary` package to test pre-commit with 'Write' access to repository.
...
* Jyoti presented a remote talk at the OSDWG session to on the topic ‘Building Bridges: Advancing Research Software Engineering and Open Science in Asia’, and also chaired the session.
